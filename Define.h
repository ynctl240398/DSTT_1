...
#define WHIP_STATE_NORMAL	1

#define WHIP_I_ANI_BEHIND_SIMON_STAND_RIGHT	1
#define WHIP_I_ANI_FRONT_SIMON_STAND_RIGHT	2
#define WHIP_I_ANI_BEHIND_SIMON_STAND_LEFT	3
#define WHIP_I_ANI_FRONT_SIMON_STAND_LEFT	4
